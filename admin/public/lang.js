...
window.translations = {
  ...
  overallDegraded: 'Některé služby mají problém',
    ...
    test: "Test",
    whereToFind: "Kde klíč najít?",
    termClear: "Vymazat",
    termCopy: "Kopírovat",
    termReady: "Terminál připraven. Spusťte akci...",
    termCleared: "Terminál vymazán.",
    termCopied: "Výstup zkopírován do schránky.",
    termTestAll: "Test všech klíčů",
    termTestOne: "Test",
  },
  en: {
  dashboard: 'Dashboard',
  ...
  overallDegraded: 'Some services have issues',
    ...
    testAll: "Test All",
    test: "Test",
    whereToFind: "Where to find the key?",
    termClear: "Clear",
    termCopy: "Copy",
    termReady: "Terminal ready. Run an action...",
    termCleared: "Terminal cleared.",
    termCopied: "Output copied to clipboard.",
    termTestAll: "Test all keys",
    termTestOne: "Test",
  }
};
